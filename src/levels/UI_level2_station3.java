...
public class UI_level2_station3 extends JFrame {
    ...
    public UI_level2_station3() {
        this.levelData = levelDataLoader.loadLevel(2, 1);

        setTitle("Station Saga - Level 2 (Station 3)");
    ...
    private void updateControllerState(DialogueEntry entry) {
        ...
        // sticky permissions: only ever set to true
        ...
        updateNextEnabled(); // gate Next based on requirement state
    }
    ...
    private void showPreviousDialogue() {
        ...
        updateNextEnabled(); // re-evaluate gating for the previous step
    }
