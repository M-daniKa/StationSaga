...
public class UI_level4 extends JFrame {
    ...
    public UI_level4() {
        this.levelData = levelDataLoader.loadLevel(4);

        setTitle("Station Saga - Level 4");
        ...
        JPanel mainPanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                ImageIcon bgIcon = new ImageIcon(getClass().getResource("/levelBackground/Level4.png"));
        ...
        JLabel placeholder = new JLabel("Level 4 Interaction Placeholder");
