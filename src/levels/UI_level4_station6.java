...
public class UI_level4_station6 extends JFrame {
    ...
    private void initializeTrainCarsForLevel3() {
        // Example Level 3 setup: varied capacities including overloaded cars
        trainCar head = new trainCar(trainCar.carType.PASSENGER, 40, trainCar.carState.AVAILABLE);
        head.setImagePath("/Train/Head.png");
        track.addCar(head);

        int[] caps = {25, 60, 15, 55, 35, 70};
        for (int cap : caps) {
            trainCar car = new trainCar(trainCar.carType.PASSENGER, cap, trainCar.carState.AVAILABLE);
            car.setImagePath("/Train/TrainCar.png");
            track.addCar(car);
        }
        // ensure initial paint
        SwingUtilities.invokeLater(() -> {
            if (trainPanel != null) trainPanel.repaint();
        });
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new UI_level4_station6().setVisible(true));
    }
}
